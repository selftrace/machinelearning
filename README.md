...
One interesting thought was about the time complexity of KNN. At first we were throwing around the idea that it might be O(n²), which sounds reasonable when all you think about is distance calculations. But after breaking it down properly, I realised that's not really what's happening.
